  ...
  <div id="home">
    ...
    <section id="info">
      <div class="info-item">
        <h2>About</h2>
        <p>
          telegram.js is a powerful <a href="https://nodejs.org/">node.js</a> module that allows you to interact with the
          <a href="https://core.telegram.org/bots/api">Telegram Bot API</a> very easily.
        ...
        <p>
          Usability, consistency, and performance are key focuses of telegram.js, and it also has nearly 100% coverage of the Telegram Bot API.
        </p>
      </div>
